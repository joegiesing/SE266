...
//  5) Return results if needed.
    ...
    public function addpatient($firstname, $lastname, $birthdate, $married) 
    {
        ...
        $stmt = $patientTable->prepare("INSERT INTO patients SET patientFirstName = :fnParam, patientLastName = :lnParam, patientMarried = :mdParam, patientBirthDate = :bdParam");
    ...
    public function updatepatient ($id,$fnParam, $lnParam, $bdParam, $mdParam) 
    {
        ...
        $stmt = $patientTable->prepare("UPDATE patients SET patientFirstName = :fnParam, patientLastName = :lnParam, patientMarried = :mdParam, patientBirthDate = :bdParam WHERE id = :idParam");
